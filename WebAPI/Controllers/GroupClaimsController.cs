...
namespace WebAPI.Controllers
{
    ...
    public class GroupClaimsController : BaseApiController
    {
        ...
        {
            return GetResponseOnlyResultMessage(await Mediator.Send(new UpdateGroupClaimCommand { GroupId = updateGroupClaimDto.GroupId, ClaimIds = updateGroupClaimDto.ClaimIds }));
        }
